...
export const FocusDonutChart = () => {
  ...
  <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
    {/* Yesterday Card */}
    <div className="rounded-xl bg-cyan-100/70 shadow-sm p-6">
      <h3 className="mb-4 text-sm font-semibold text-yellow-800 uppercase">Yesterday’s Focus</h3>
    ...
    {/* Today Card */}
    <div className="rounded-xl bg-pink-100/70 shadow-sm p-6">
      <h3 className="mb-4 text-sm font-semibold text-pink-800 uppercase">Today’s Focus</h3>
      <div className="relative">
        <ResponsiveContainer width="100%" height={220}>
          <PieChart>
            <Pie
